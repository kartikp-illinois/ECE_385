...
HD_PWD='C:/Users/karti/Documents/ECE_385/Lab6/Lab6.runs/mb_block_xbar_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_block_xbar_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_block_xbar_2.tcl
