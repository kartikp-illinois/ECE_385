...
HD_PWD='C:/Users/karti/Documents/ECE_385/Lab4Test/Lab4Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xab_mult_complete.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xab_mult_complete.tcl
