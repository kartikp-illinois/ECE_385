...
HD_PWD='C:/Users/karti/Documents/ECE_385/Lab4Test/Lab4Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log xab_mult_complete.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source xab_mult_complete.tcl -notrace
